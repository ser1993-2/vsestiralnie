...
/**
 * Class YandexNewUserChartController
 * @package App\Http\Controllers\Admin\Charts
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class YandexNewUserChartController extends ChartController
{
    public function setup()
    {
        $stats = Stats::getStatByAlias('yandex_search');
     ...
     */
     ...
     {
         $statsId = Stats::getStatIdByAlias('yandex_search');
